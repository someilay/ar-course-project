---
title: "Feedback control over constrained robotic systems with ROS 2 / Gazebo"
callout-icon: false
author:
  - name: Ilia Milioshin
...
::: {.fragment .fade-up}
* [ROS2 Humble]{style="color:indigo;"} @ROS2Humble - as core for control computation
:::

::: {.fragment .fade-up}
* [Gazebo Fortress]{style="color:green;"} @Gazebo - simulation environment
:::
...
![Data flow of $\texttt{ros_control}$ and Gazebo](images/figures/Gazebo_ros_transmission.png){#fig-dual-arm-yumi width=100%}
...
## $\texttt{YumiInverseDynamicsController}$

{{< video videos/id_controller.mp4 >}}

## $\texttt{YumiUdwadiaController}$

{{< video videos/udwadia_controller.mp4 >}}
